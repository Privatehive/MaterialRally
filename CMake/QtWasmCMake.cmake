...
function(add_qt_wasm_app TARGET)
  ...
  if(NOT ARGWASM_DISABLE_DEPLOYMENT)
    ...
    install_files("bin" FILES "$<TARGET_FILE_DIR:${TARGET}>/qtlogo.svg" "$<TARGET_FILE_DIR:${TARGET}>/qtloader.js" "$<TARGET_FILE_DIR:${TARGET}>/${ARGWASM_NAME}.html" "$<TARGET_FILE_DIR:${TARGET}>/${ARGWASM_NAME}.wasm")
  endif()
endfunction()
